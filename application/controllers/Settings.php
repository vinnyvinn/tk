...
class Settings extends Pre_loader {
    ...
    function save_general_settings() {
        $settings = array("site_logo", "invoice_logo", "show_background_image_in_signin_page", "show_logo_in_signin_page", "app_title", "language", "timezone", "date_format", "time_format", "first_day_of_week", "default_currency", "currency_symbol", "decimal_separator", "accepted_file_formats", "rows_per_page", "item_purchase_code", "scrollbar");
