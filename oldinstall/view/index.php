...
<!--                                            <div class="col-md-9">-->
<!--                                                <input type="text" value="a98e9966-faae-43b8-baa5-168b1a813b70"  id="purchase_code"  name="purchase_code" class="form-control"  placeholder="Find in codecanyon item download section" />-->
<!--                                            </div>-->
<!--                                        </div>-->
<!--                                    </div>-->
<!--                                </div>-->
